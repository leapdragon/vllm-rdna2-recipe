...
| **[TROUBLESHOOTING.md](TROUBLESHOOTING.md)** | Symptom → cause → fix, grouped by problem area: runtime configuration (the V2 model runner, TunableOp rows, compile caches, P2P level), multi-GPU stability, mixed-GPU machines, host builds, measuring correctly. Start with its §0. |
